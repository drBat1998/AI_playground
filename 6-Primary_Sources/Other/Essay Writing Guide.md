...
> boolshit, Greek and Roman philosophy makes us who we are
...
That means that you will be able to separate the wheat from the chaff (look it up). Then you can be properly influenced by profound and solid ideas instead of falling prey to foolish fads and whims and ideologies, which can range in their danger from trivial to mortal.
...
> In conclusion, JP said that I should get up early, eat, and write every day. 
...
Don’t worry too much about how well you are writing at this point. It is also best at this point not to worry too much about the niceties of sentence structure and grammar. That is all best left for the second major step, which is editing.

You should think of the essay writing process as twofold. The first major step is the first draft, which can be relatively quick and dirty. For the first draft you can use your notes, extensively, and rough out the essay. If you get stuck writing anywhere, just move to the next outline sentence. You can always go back. 
...
Liberal and conservative thinkers stress efficiency of production, as well as quality, and consider profit the motive for efficiency. They believe that lower cost is a desirable feature of production, and that fair competition helps ensure desirably lower prices. 
...
# Notes
## 1. Introduction
An essay is an attempt to explore a topic
The primary reason to write an essay is to formulate and organize a set of ideas about something important

There is no better way to think, the essay provides the ability to organize and rearrange ideas, change them, and improve them, sentence by sentence. 

Everyday routine in the morning for 15 minutes at least should improve your thinking. 
## 2. Levels of resolution
The paragraph should be at least 10 sentences or 100 words. Each sentence has to be grammatically and logically correct. 
One paragraph should present a single idea. 
All of the paragraphs have to be arranged in a logical progression.
There are five key levels of the essay and a few additional. Words, sentences, paragraphs, logical flow of paragraphs, and essay as a whole are five key levels.  A few additional levels refer to thoughts about readers who would interpret your essay. If you do a good job with the first five you complete your thought, but you could fail to communicate that thought to the audience. 

## 3. The topic and the reading list
Find the topic to write about and form a reading list. If you can't create a topic sentence, you should continue your reading journal.

You have to summarise key points and insides from the paper; it is essential to determine how you interpret them.

> Maybe it is useful to separate two types of notes, The first one is notes that you create during reading sessions and another that created with some separation of time. 

Assume you need 5-10 books or articles per thousand words of essay, unless you have been instructed otherwise. A double-spaced page of typing usually contains about 250 words. List your sources now, even if you have to do it badly. Out of those notes you should be able to derive 8-10 topic questions. Do so. Remember, they can be edited later. Just get them down.

## 4. The outline
You have to write 25 % more than you want, due to the inevitability to throw some shit away. 

The outline could be calculated as one outline sentence to 100 words of essay, but not bigger than 15 sentences, due to its difficulty to maintain the arguments in the brain for a long time. 
## 5. Paragraphs
First, write and then edit. 

## 6. Editing and arranging of sentences within paragraphs
1. Write a paragraph sentence by sentence in a list fashion.
2. Read the sentences one by one out loud and think if they sound good and how could you improve them
