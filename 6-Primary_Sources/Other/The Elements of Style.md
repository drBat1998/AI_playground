...
"because"), for, or, nor, or while (in the sense of "and at the same time") likewise require a
...
useful if the connective is but. When the connective is and, the comma should be omitted if
...
- If two or more clauses are grammatically complete and not joined by a conjunction, the proper mark of punctuation is a semicolon or periods. 
- If a conjunction is inserted, the proper mark is a comma. 
- Strunk suggests the semicolon is the best way to combine two closely related sentences.
- if the second clause is preceded by an adverb, such as
	- accordingly, 
	- besides,
	- then, 
	- therefore,
